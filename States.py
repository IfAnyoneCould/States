...
class State():
    ...
    def Render(self,window):
        ...
        for i in self.text:
            i.Render(window)
#alabama
alabamaData = State(["Alabama"],["Capitol: Montgomery","Population: 200,603"],["Established in 1846","Rank in state: 17th"],["Yellowhammer"],["Colaptes auratusa"],["Camellia","Genus: Theaceae,"],["Medicinal uses:The flowers are astringent,","antihemorrhagic, haemostatic,","salve and tonic.","When mixed with sesame oil,","they are used in the treatment of burns and scalds."],["Flag was adopted in 2015","U.S. state flag consisting of a white field with a red saltire (diagonal cross),represented the sepration of Alabama from the Union"])
...
#florida
floridaData = State(["Florida"],["Capitol: Tallahassee","Population: 196,169"],["Established in 1824","Rank in state: 1st"],["Northern mockingbird"],["Mimus polyglottos"],["Orange Blossom"," genus citrus"],["Medicinal uses: Reduces cortisol levels, lowers blood pressure,","improves menopausal symptoms, Reduces inflammation,","acts as an antimicrobial substance, exerts antispasmodic effects,","acts as an anticonvulsant."],["Was adopted in 1868","The Florida state flag's current design features diagonal red bars and the state seal To art majors, it's a satire, a heraldic symbol.","To theologians, it's a St. Andrew's Cross,","The seal features a brilliant sun, a cabbage palmetto tree,","a steamboat sailing and a Native American Seminole woman scattering flowers."])
